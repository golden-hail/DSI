...
We've been looking through a lot of our customer feedback lately - and one thing in particular has come up a number of times.

Our customers know we have a great range of competitively priced products in our clothing section - but they are struggling to find the products they are looking for on our website.
...
I've seen the incredible work you've done using Convolutional Neural Networks in your last project - and wondered if any of this could be applied to the problem we are describing here?

Can Deep Learning be used to help customers find the products that they're after? We have provided you some data to use for testing - let us know how you get on!
...
###########################################################################################
# preprocessing & featurizing functions
###########################################################################################
