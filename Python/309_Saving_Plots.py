...
plt.annotate(text = f"Median Weight ({round(median_weight)} lbs)", 
             ...
             xytext = (10, -10), 
             textcoords = "offset pixels", # can also use offset_points
             fontsize = 16) 
...
plt.tight_layout()
plt.savefig(fname = "exported_plot.png") # can add color of plot, edge color or orientation
